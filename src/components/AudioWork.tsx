...
const AudioWork = () => {
  ...
  const audioProjects: AudioProjectProps[] = [
    {
      year: 2024,
    ...
    },
    {
      ...
      links: {
        platform: "soundcloud",
        url: "https://soundcloud.com/luke-mastrocola/aglow?si=3bb7ecd909f64075bdb9b2252e09872e&utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
      },
    },
    {
      year: 2024,
  ...
  type ActionLinkProps = {
    links: AudioProjectProps["links"];
  };

  const ActionLink = ({ links }: ActionLinkProps) => {
    const theme = useTheme();
    const isYT = links.platform === "youtube";
